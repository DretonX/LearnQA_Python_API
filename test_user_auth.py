...
class TestUserAuth:
    def setup_method(self):
        ...
        assert 'auth_sid' in response1.cookies, "There is no auth_sid cookie in the response"
        assert 'x-csrf-token' in response1.headers, "There is no x-csrf-token header in the response"
